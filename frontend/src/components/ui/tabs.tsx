...
>(({ className, ...props }, ref) => (
    <TabsPrimitive.List
        ref={ref}
        className={cn(
            "inline-flex h-11 items-center justify-center rounded-lg bg-slate-800/50 p-1 text-slate-400 border border-slate-700",
            className
        )}
        {...props}
    />
